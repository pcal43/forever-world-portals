...
import net.pcal.fwportals.client.config.ClientConfig;
import net.pcal.fwportals.client.config.ClientConfigLoader;
import net.pcal.fwportals.client.effects.TintedPortalBlockStateModel;
...
public final class ClientService {
    ...
    private ClientConfig ensureConfigLoaded() {
        if (config == null) {
            config = ClientConfigLoader.load(LOGGER);
        }
        return config;
    }
