...
final class ConfigParser {
    ...
    static Config parseBundledDefaults(Properties bundledDefaults, String defaultResourceName) {
    ...
    static Config parse(
        ...
        Config.DestinationPortalMode destinationPortalMode = parseDestinationPortalMode(
                properties,
                "server.destinationPortalMode",
    ...
    private static Config.DestinationPortalMode parseDestinationPortalMode(
            Properties properties,
            String key,
            Config.DestinationPortalMode defaultValue,
            Logger logger
    ) {
        String value = properties.getProperty(key);
        if (value == null) {
        ...
        try {
            return Config.DestinationPortalMode.valueOf(value.trim());
    ...
    private static Config buildInternalDefaults(Properties bundledDefaults, String defaultResourceName) {
        return new Config(
    ...
    private static Config.DestinationPortalMode requireParsedDestinationPortalModeDefault(
            String defaultResourceName,
            String key,
            String defaultValue
    ) {
        try {
            return Config.DestinationPortalMode.valueOf(defaultValue.trim());
        } catch (IllegalArgumentException ignored) {
        }
