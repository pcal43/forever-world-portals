...
public final class PortalIdentity {
    ...
    public BlockPos computeAnchorBlock(ForeverWorldPortalFrame frame) {
    ...
    public boolean portalEnclosesAnchor(ForeverWorldPortalFrame frame, BlockPos anchorBlock) {
